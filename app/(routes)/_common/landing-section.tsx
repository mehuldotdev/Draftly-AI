      ...
      <div className="flex flex-col">
        ...
        "
          >
            ...
            "
              >
                Craft your <span className="text-blue-400">Draft</span> <br className="md:hidden" />
                <span className="text-primary">in minutes</span>
              </h1>
              <div className="mx-auto max-w-2xl ">
                <p className="text-center font-medium text-foreground leading-relaxed sm:text-lg">
                  Allow Draftly to be your AI design partner. Describe your app idea, and kickstart building today.
                </p>
              </div>
            </div>
